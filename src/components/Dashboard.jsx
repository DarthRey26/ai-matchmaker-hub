...
const Dashboard = ({ students, companies }) => {
  const stats = {
    ...
    averageMatchAccuracy: Math.round(students.reduce((acc, s) => acc + s.match1 + s.match2, 0) / (students.length * 2)),
  };
  ...
  const facultyData = [
    { name: 'Law', value: 40, color: '#2196F3' },
    { name: 'Engineering', value: 20, color: '#FF9800' },
    { name: 'Business', value: 20, color: '#9C27B0' },
    { name: 'Arts', value: 20, color: '#00BCD4' },
  ];

  const industryData = [
    { name: 'Legal', value: 40, color: '#3F51B5' },
    { name: 'Finance', value: 20, color: '#E91E63' },
    { name: 'Technology', value: 20, color: '#009688' },
    { name: 'Marketing', value: 20, color: '#FF5722' },
  ];
